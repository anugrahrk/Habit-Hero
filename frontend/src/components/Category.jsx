...
function Category() {
  ...
  return (
    <div className='w-full flex md:justify-center pt-10'>
        <div className=' bg-gradient-to-r from-violet-600 to-indigo-600 w-screen md:w-3/4 text-white p-5 flex flex-wrap gap-4 justify-around rounded-lg'>
