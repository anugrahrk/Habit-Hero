  ...
  return (
    <div className='relative'>
        <div className='flex justify-around gap-80 mt-10 relative'>
            ...
            <button onClick={()=>{setaddNew(true)}} className='text-sm w-20 h-10 text-white rounded hover:cursor-pointer hover:shadow-lg shadow-gray-100 bg-red-400 flex justify-center items-center'>Add</button>
